...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(100, 220, 208, 23))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.step_Continue = QtWidgets.QRadioButton(self.widget)
        self.step_Continue.setObjectName("step_Continue")
        self.horizontalLayout.addWidget(self.step_Continue)
        self.step_Tick_By_Tick = QtWidgets.QRadioButton(self.widget)
        self.step_Tick_By_Tick.setObjectName("step_Tick_By_Tick")
        self.horizontalLayout.addWidget(self.step_Tick_By_Tick)
